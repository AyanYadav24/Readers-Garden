...
function Navbar() {
  ...
  const { state } = useCart(); // Accessing cart state
      ...
      >
        <div className="navbar ">
          <div className="navbar-start">
            ...
            <a className=" text-2xl font-bold cursor-pointer">Readers Garden</a>
          </div>
          <div className="navbar-end space-x-3">
            ...
            {/* <div className="hidden md:block">
              <label className=" px-3 py-2 border rounded-md flex items-center gap-2">
                <input
                  ...
                  placeholder="Search"
                  value={searchTerm} // Set value from prop
                  onChange={(e) => setSearchTerm(e.target.value)} // Update search term from Navbar
                />
            ...
            <label className="swap swap-rotate">
              ...
              >
                <path d="M21.64,13a1,1,0,0,0-1.05-.14,8.05,8.05,0,0,1-3.37.73A8.15,8.15,0,0,1,9.08,5.49a8.59,8.59,0,0,1,.25-2A1,1,0,0,0,8,2.36,10.14,10.14,0,1,0,21.64,13Z" />
              </svg>
            </label>
